...
Defines how the app obtains a walking polyline (via OSRM with a straight-line fallback) and how the sidecar's walker traverses that polyline with realistic speed and coordinate jitter.
## Requirements
